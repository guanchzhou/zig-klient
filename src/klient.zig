...
pub const ServiceCIDR = types.ServiceCIDR;
...
pub const MutatingAdmissionPolicy = types.MutatingAdmissionPolicy;
pub const MutatingAdmissionPolicyBinding = types.MutatingAdmissionPolicyBinding;
...
pub const TCPRoute = types.TCPRoute;
pub const TLSRoute = types.TLSRoute;
pub const UDPRoute = types.UDPRoute;
pub const BackendTLSPolicy = types.BackendTLSPolicy;
pub const ListenerSet = types.ListenerSet;
...
pub const IPAddresses = resources.IPAddresses;
pub const ServiceCIDRs = resources.ServiceCIDRs;
...
pub const MutatingAdmissionPolicies = resources.MutatingAdmissionPolicies;
pub const MutatingAdmissionPolicyBindings = resources.MutatingAdmissionPolicyBindings;
...
pub const TCPRoutes = resources.TCPRoutes;
pub const TLSRoutes = resources.TLSRoutes;
pub const UDPRoutes = resources.UDPRoutes;
pub const BackendTLSPolicies = resources.BackendTLSPolicies;
pub const ListenerSets = resources.ListenerSets;
