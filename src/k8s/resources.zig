...
pub const MutatingAdmissionPolicies = SimpleResource(types.MutatingAdmissionPolicy);
pub const MutatingAdmissionPolicyBindings = SimpleResource(types.MutatingAdmissionPolicyBinding);
